...
//		sample example with different arrival times (mid question)
		
//		Process p1 = new Process("p1",4,0);
//		Process p2 = new Process("p5",5,3);
//		Process p3 = new Process("p2",8,4);
//		Process p4 = new Process("p4",10,5);
//		Process p5 = new Process("p3",6,9);
//		
//		plist.add(p1);
//		plist.add(p2);
//		plist.add(p3);
